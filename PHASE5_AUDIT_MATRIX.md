...
6. Client `clientVisible` at *registration* time remains allowed (per L-1); parent-visibility gate in RLS contains it; PATCH-time flip (the real leak) is now refused (F6).
