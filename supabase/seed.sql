...
from (values
  ...
  (((current_date - 14) + time '09:31') at time zone 'UTC', 'cccccccc-0000-4000-8000-000000000003', '22222222-2222-4222-8222-222222222222', 'ACCOUNT_MANAGER', '10.0.0.98', 'seed-0062', 'profile', '22222222-2222-4222-8222-222222222222', 'INVITE_SENT', 'INFO', null, '{}'::jsonb, '{}'::jsonb, 'Client invites sent'),
  (((current_date - 14) + time '09:35') at time zone 'UTC', null, '22222222-2222-4222-8222-222222222222', 'ACCOUNT_MANAGER', '10.0.0.98', 'seed-0063', 'profile', '22222222-2222-4222-8222-222222222222', 'LOGIN', 'INFO', null, '{}'::jsonb, '{}'::jsonb, 'Admin login to onboard'),
  (((current_date - 3) + time '08:00') at time zone 'UTC', null, '11111111-1111-4111-8111-111111111111', 'PLATFORM_ADMIN', '10.0.0.21', 'seed-0064', 'profile', '11111111-1111-4111-8111-111111111111', 'LOGIN', 'INFO', null, '{}'::jsonb, '{}'::jsonb, 'Platform login'),
  (((current_date - 20) + time '09:00') at time zone 'UTC', null, '44444444-4444-4444-8444-444444444444', 'CLIENT_ADMIN', '10.0.0.140', 'seed-0065', 'profile', '44444444-4444-4444-8444-444444444444', 'LOGIN_FAILED', 'WARNING', null, '{}'::jsonb, '{}'::jsonb, 'Failed login (wrong password)'),
  (((current_date - 30) + time '10:00') at time zone 'UTC', null, '11111111-1111-4111-8111-111111111111', 'PLATFORM_ADMIN', '10.0.0.170', 'seed-0066', 'profile', '70000000-0000-4000-8000-000000000007', 'ROLE_GRANT', 'CRITICAL', array['platform_role'], '{}'::jsonb, '{}'::jsonb, 'ADMIN granted (contractor, time-boxed)'),
  (((current_date - 92) + time '08:30') at time zone 'UTC', null, '70000000-0000-4000-8000-000000000006', 'PLATFORM_ADMIN', '10.0.0.65', 'seed-0067', 'profile', '70000000-0000-4000-8000-000000000006', 'LOGIN', 'INFO', null, '{}'::jsonb, '{}'::jsonb, 'Platform login before revocation'),
  (((current_date - 90) + time '11:00') at time zone 'UTC', null, '11111111-1111-4111-8111-111111111111', 'PLATFORM_ADMIN', '10.0.0.210', 'seed-0068', 'profile', '70000000-0000-4000-8000-000000000006', 'ROLE_REVOKE', 'CRITICAL', array['platform_role'], '{}'::jsonb, '{}'::jsonb, 'zoe ADMIN revoked'),
  (((current_date - 1) + time '08:00') at time zone 'UTC', null, '11111111-1111-4111-8111-111111111111', 'PLATFORM_ADMIN', '10.0.0.7', 'seed-0069', 'profile', '11111111-1111-4111-8111-111111111111', 'LOGIN', 'INFO', null, '{}'::jsonb, '{}'::jsonb, 'Platform login'),
  ...
  (((current_date - 60) + time '10:00') at time zone 'UTC', 'bbbbbbbb-0000-4000-8000-000000000002', '80000000-0000-4000-8000-000000000004', 'CLIENT_MEMBER', '10.0.0.170', 'seed-0071', 'profile', '80000000-0000-4000-8000-000000000004', 'INVITE_ACCEPTED', 'INFO', null, '{}'::jsonb, '{}'::jsonb, 'gwen accepted invite'),
  (((current_date - 90) + time '09:00') at time zone 'UTC', null, '70000000-0000-4000-8000-000000000006', 'PLATFORM_ADMIN', '10.0.0.130', 'seed-0072', 'profile', '70000000-0000-4000-8000-000000000006', 'SOFT_DELETE', 'NOTICE', array['deleted_at'], '{}'::jsonb, '{}'::jsonb, 'zoe team membership soft-deleted')
